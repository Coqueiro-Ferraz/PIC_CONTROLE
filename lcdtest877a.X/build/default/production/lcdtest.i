...
static void muda_pin(volatile unsigned char *_port, int _pin, int _val);
static void enable(void);
static void nibble(int dado);
static void byte (int escreve, char dado);
